...
// //     separa = random(1.1, 4.5);//sep; // random(3.1, 8.5);
// //     alignm =random(2.5,4.5); //ali; // random(1.5,8.5);
// //     cohesi = random(2.5,4.5);//coh; // random(1.5,8.5);
...
// //     drawPixelXYF(boid->location.x, boid->location.y, ColorFromPalette(HeatColors_p, boid->hue * 15, 255, NOBLEND));
